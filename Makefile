...
pdf:
	$(SPHINXBUILD) -T -b pdf $(ALLSPHINXOPTS) _build/pdf
	 @echo
...
latex:
	...
	patch build/latex/test.tex test.tex.use_kotex.patch 
	@echo "Applied kotex patch"
	#patch build/latex/sphinx.sty sphinx.sty.bookmark_fix.patch
	#@echo "Applied bookmark patch"
